        ...
        <div className="info-bar">
          <div>
            <span style={{ display: "inline" }}>
              <small>
                <b>{result.views} views</b>
              </small>
              <small> • </small>
              <small>
                <b>{result.releaseDate}</b>
              </small>
            </span>
          </div>
          ...
          <div className="actions">
            ...
            {watchlater ? (
              <span>{font(faCheck)}</span>
            ) : (
              <span onClick={AddHandler}>{font(faClock)}</span>
            )}
            ...
            return (
              <Link to={`/watch/${item.videoid}`}>
                <div key={item.id} className="history-card-watch">
                  ...
                  <div className="history-detail-watch">{item.title}</div>
                </div>
              </Link>
            );
          })}
